...
public class VideoBrowserListFragment extends ListFragment implements
     ...
     */
    @Override
    public void onLoadFinished(Loader<List<MediaItem>> arg0, List<MediaItem> data) {
     ...
     */
    @Override
    public void onLoaderReset(Loader<List<MediaItem>> arg0) {
        mAdapter.setData(null);
    }

    @Override
    public void onListItemClick(ListView l, View v, int position, long id) {
        MediaItem selectedMedia = mAdapter.getItem(position);
        handleNavigation(selectedMedia, false);
    }

    private void handleNavigation(MediaItem info, boolean autoStart) {
        Intent intent = new Intent(getActivity(), LocalPlayerActivity.class);
        intent.putExtra("media", info.toBundle());
     ...
     */
    @Override
    public Loader<List<MediaItem>> onCreateLoader(int arg0, Bundle arg1) {
